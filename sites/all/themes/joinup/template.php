...
function joinup_preprocess_page(&$vars) {
  ...
  $theme_setting = variable_get ('theme_'.variable_get('theme_default','joinup_').'_settings','theme_joinup_settings');
    ...
    if ($nid || $_GET['q'] == 'node/add/project-project') {
      ...
      if ($type == ISA_CASE_TYPE) {
        switch (isa_toolbox_get_case_type($node)) {
          case 1 : $type = ISA_SOFTWARE_TYPE; break;
          case 2 : $type = ISA_SOFTWARE_TYPE; break;
        }
      }
