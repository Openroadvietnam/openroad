...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="<?php print $language -> language ?>" lang="<?php print $language -> language ?>" dir="<?php print $language -> dir ?>">
	...
	<body class="js">
		...
		<div class="layout  <?php echo $extra_layout_css ?>" id="layout">
			...
			<div class="layout-body-offline">
				
				
				<p class="off-screen"><?php print t('Additional tools') ?></p>
					<ul class="reset-list" id="additional-tools"></ul>
				<div class="layout-wrapper fluid container_16">
					<div class="layout-wrapper-reset clearfix">
							...
							<?php endif; ?>
								<div id="content" class="fluid-<?php print $content_colspan; ?>">
									<?php if ($show_messages && $messages): print $messages; endif; ?>
								       <?php if ($tabs): ?>
									       <div id="tabs-wrapper" class="advancedSearchTabs2">
										       <?php print $tabs ?>
									       </div>
								       <?php endif; ?>
				...
				<div class="layout-right <?php echo $right_column_class?>">
					<?php if ($right): ?>
			...
			<div class="layout-footer">
				<div id="footer" class="grid16col clearfix">
					<div id="footer-region" class="colspan-16">
						<div class="block clearfix" id="block-block-12">
						<div class="content">
						<div class="content">
							<a target="_blank" href="http://ec.europa.eu/isa/"><img width="83" height="88" src="<?php echo base_path(). path_to_theme() ?>/images/logo/logo_isa.png" longdesc="http://ec.europa.eu/isa/" alt="isa_logo"></a></div><a class="context-block editable edit-general_footer" id="context-block-block-12"></a>	</div>
							</div>
					</div>	<!-- /#footer-region -->
