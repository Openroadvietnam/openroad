...
/**
 * @file
 * Theme implementation to display a single Drupal page while database off-line.
 * @see template_preprocess()
 * @see template_preprocess_maintenance_page_offline()
 * @ingroup pages
 */
?>
...
<?php global $base_url;?>
<?php  $theme_path = $base_url.'/sites/all/themes/joinup';?>
<link type="image/x-icon" href="<?php print $theme_path; ?>/images/logo/favicon.ico" rel="shortcut icon">
<link type="text/css" rel="stylesheet" media="all" href="<?php print $theme_path; ?>/styles/default/reset.css" />
<link type="text/css" rel="stylesheet" media="all" href="<?php print $theme_path; ?>/styles/default/grid.css" />
<link type="text/css" rel="stylesheet" media="all" href="<?php print $theme_path; ?>/styles/default/common.css" />
<link type="text/css" rel="stylesheet" media="all" href="<?php print $theme_path; ?>/styles/default/style.css" />
<link type="text/css" rel="stylesheet" media="all" href="<?php print $theme_path; ?>/styles/default/forms.css" />
<link type="text/css" rel="stylesheet" media="all" href="<?php print $theme_path; ?>/styles/default/dashboard.css" />
<link type="text/css" rel="stylesheet" media="print" href="<?php print $theme_path; ?>/styles/default/print.css" />
		...
		<div id="breadcrumb-wrapper">
			<div id="breadcrumb" class="grid16col clearfix">
				<div class="colspan-16">
					...
					<p><strong><a href="http://ec.europa.eu/">European Commission</a> &rsaquo; <a href="http://ec.europa.eu/isa/">ISA</a> &rsaquo; Joinup &rsaquo; <?php if ($breadcrumb): print $breadcrumb; endif; ?></strong></p>
				</div>
			</div>
		</div>
