 ...
 * 
 * Available variables:
 * $info_text_login : information to login for anonymous user when he want download release
 * $login_link : link to login page
 * $info_text_download : information about the anonymous download
 * $file_link : the file link
