 ...
 * @file
 *
 * Theme implementation to display an asset.
 *
 * Available variables:
 ...
 * @see _joinup_preprocess_project_project()
 * @see _joinup_preprocess_asset()
 * 
 *  @ingroup nodes
 */
?>
		...
		<div id="node-information" class="box information">
			...
			<div class="odd nodes-row-first nodes-row-last clearfix">
				<dl class="colspans-3-5 first last fields">
					...
					<?php endif; ?>
                                        <?php if ($webdir_url): ?>
						<dt class="field field field-webdir-term"><?php print t('Web directory') ?>:</dt>
						<dd class="field field field-webdir-description"><?php print $webdir_url; ?></dd>
					<?php endif; ?>
                                        <?php if ($webdav_url): ?>
						<dt class="field field field-webdav-term"><?php print t('WebDAV') ?>:</dt>
						<dd class="field field field-webdav-description"><?php print $webdav_url; ?></dd>
					<?php endif; ?>
