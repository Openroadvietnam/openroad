  ...
  <div class="node-content">
    ...
    /** ----------- TEASER ---------------*/?>
      <div class="odd nodes-row-first nodes-row-last clearfix">
        <dl class="align-left">
          <dt class="field field-label-term"><?php print t('Label'); ?>:</dt>
          <dd class="field field-label-description"><?php print $title_link; ?></dd>
          ...
          <?php endif; ?>
          <?php if (!empty($field_contact_point_name_rendered)): ?>
            <dt class="field field-name-term"><?php print t('Name'); ?>:</dt>
            <dd class="field field-name-description"><?php print $field_contact_point_name_rendered; ?></dd>
          <?php endif; ?>
        </dl>
      </div>
    <?php endif; ?>
