   ...
   /** ----------- TEASER ---------------*/?>
      <div class="odd nodes-row-first nodes-row-last clearfix">
        <dl class="align-left">
          ...
          <?php endif; ?>
          <?php if (!empty($field_documentation_access_url1_rendered) || !empty($field_documentation_access_url_rendered)): ?>
            <dt class="field field-url-access-term"><?php print t('URL Access'); ?>:</dt>
            <dd class="field field-url-access-description">
              <?php print $field_documentation_access_url_rendered; ?>
              <?php print $field_documentation_access_url1_rendered; ?>
            </dd>
          <?php endif; ?>
        </dl>
      </div>
