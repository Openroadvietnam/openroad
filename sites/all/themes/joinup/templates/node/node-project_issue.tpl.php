...
* @file
*
* Theme implementation to display an issue.
*
* Available variables:
...
* @see _joinup_preprocess_project_issue()
 *  @ingroup nodes
*/
?>
<div id="node-<?php print $node->nid; ?>" class="node node-type-<?php print $node->type?> <?php if ($sticky) { print ' sticky'; } ?> <?php if (!$status) { print ' node-unpublished'; } ?> clear-block">
	<div class="node-content">
      ...
      <?php  if (isset($field_project_issues_attachement_rendered)): ?>
			<div class="field field-documentation">
				<h3 class="page-subtitle-content"><?php print t('Attachment'); ?></h3>
                <?php print $field_project_issues_attachement_rendered; ?>
			</div>
		<?php endif; ?>
