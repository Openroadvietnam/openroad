...
<div id="node-<?php print $node->nid; ?>" class="node node-type-<?php print $node->type?> <?php if ($sticky) { print ' sticky'; } ?> <?php if (!$status) { print ' node-unpublished'; } ?> clear-block">
	<div class="node-content">
		...
		<?php if (!empty($node->field_forges_get_involved['0']['value'])): ?>
			...
			<div class="view view-project-node">
				...
				<div class="view-content">
					<div class="field field-get-involved"><?php print $node->field_forges_get_involved['0']['value']; ?></div>
				</div>
			...
			<div class="odd nodes-row-first nodes-row-last clearfix">
				<dl class="colspans-3-5 first last fields">
					<?php if ($homepage): ?>
						...
						<dd class="field field-homepage-description"><?php print $homepage['url']; ?></dd>
					<?php endif; ?>
