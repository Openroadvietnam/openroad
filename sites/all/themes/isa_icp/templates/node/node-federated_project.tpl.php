...
<div id="node-<?php print $node->nid; ?>" class="node node-type-<?php print $node->type?> <?php if ($sticky) { print ' sticky'; } ?> <?php if (!$status) { print ' node-unpublished'; } ?> clear-block">
	<div class="node-content">
		...
		<?php if (!empty($node->field_project_soft_features['0']['value'])): ?>
			...
			<div class="view view-project-node">
				<div class="view-header">
					<p><a href="#" title="Reduce the Features" class="reduce">Reduce<span class="accessibility-info"> the Features description</span></a></p>
				</div>
				<div class="view-content">
					<div class="field field-features"><?php print $node->field_project_soft_features['0']['value']; ?></div>
				</div>
				<div class="view-footer">
					<p>... <a class="read-more" title="Read more about Features" href="#">Read more<span class="accessibility-info"> about Features</span></a></p>
				</div>
			</div>
		<?php endif; ?>
		<?php if (!empty($node->field_project_soft_future_plans['0']['value'])): ?>
			...
			<div class="view view-project-node">
				<div class="view-header">
					<p><a href="#" title="Reduce the Future plans" class="reduce">Reduce<span class="accessibility-info"> the Future plans description</span></a></p>
				</div>
				<div class="view-content">
					<div class="field field-future-plans"><?php print $node->field_project_soft_future_plans['0']['value']; ?></div>
				</div>
				<div class="view-footer">
					<p>... <a class="read-more" title="Read more about Future plans" href="#">Read more<span class="accessibility-info"> about Future plans</span></a></p>
				</div>
			</div>
		<?php endif; ?>
		<?php if (!empty($node->field_project_soft_get_involved['0']['value'])): ?>
			...
			<div class="view view-project-node">
				<div class="view-header">
					<p><a href="#" title="Reduce the Get involved" class="reduce">Reduce<span class="accessibility-info"> the Get involved description</span></a></p>
				</div>
				<div class="view-content">
					<div class="field field-get-involved"><?php print $node->field_project_soft_get_involved['0']['value']; ?></div>
				</div>
				<div class="view-footer">
					<p>... <a class="read-more" title="Read more about Get involved" href="#">Read more<span class="accessibility-info"> about Get involved</span></a></p>
				</div>
			</div>
		<?php endif; ?>
		...
		<h3><?php print t('Public administration reference'); ?></h3>
			<div class="view view-project-node">
				<div class="view-header">
					<p><a href="#" title="Reduce the Public administration reference" class="reduce">Reduce<span class="accessibility-info"> the Public administration reference description</span></a></p>
				</div>
				<div class="view-content">
					<div class="field field-public-admin"><?php print $node->field_project_soft_public_admin['0']['value']; ?></div>
				</div>
				<div class="view-footer">
					<p>... <a class="read-more" title="Read more about Public administration reference" href="#">Read more<span class="accessibility-info"> about Public administration reference</span></a></p>
				</div>
			</div>
		<?php endif; ?>
