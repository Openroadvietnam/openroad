...
-- moved release module
UPDATE `system` SET `filename` = 'sites/all/modules/contributed/modified/release/project_release.module' WHERE `name` = 'project_release' LIMIT 1 |


-- up variables
REPLACE INTO `variable` (`name`, `value`) VALUES
('og_user_roles_roles_project_project', 'a:10:{i:9;i:9;i:4;i:4;i:5;i:5;i:17;i:17;i:6;i:0;i:14;i:0;i:16;i:0;i:8;i:0;i:3;i:0;i:13;i:0;}'),
('release_manager_rid','s:2:"17";') |
