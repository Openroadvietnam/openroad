...
<p>The Joinup team has developed a widget, that can be included in your  website, allowing your visitors to search for assets hosted either by Joinup. The search results are displayed in English, in a  new window.&nbsp;</p>
...
<ol>
    <li>Download the <a href="../sites/default/files/widget/widget_asset.zip">zip file</a></li>
    ...
    <li>Change the path to point to your css location.</li>
</ol>
<div class="block"><code><span class="red"><br />
...
&lt;div&gt;Search Asset on Joinup &lt;img src=&quot;img/1251192308_zoom in.png&quot; width=&quot;25&quot; height=&quot;25&quot; /&gt;&lt;/div&gt;<br />
&lt;/div&gt;&lt;/div&gt;<br />
&lt;div class=&quot;line&quot;&gt;<br />
...
&lt;div align=&quot;right&quot;&gt;&lt;a href=&quot;http://joinup.ec.europa.eu&quot; title=&quot;Joinup&quot; target=&quot;_blank&quot;&gt;<br />
<br />
...
<p></p>
<p><code><img alt="widget example" src="../sites/default/files/widget/widget_asset.png" /></code></p>
</div>';
$widget = node_save($newNode);

$nid_widget = $newNode->nid;
$delete_alias = "Delete from `url_alias` where  dst = '%page/widget_asset%'";
...
VALUES (
NULL , 'node/{$nid_widget}','page/widget_asset',  'en'
);";
...
$sql = "INSERT INTO `files` (`fid`, `uid`, `filename`, `filepath`, `filemime`, `filesize`, `status`, `timestamp`) 
  VALUES (NULL, '1', 'widget_asset.zip', 'sites/default/files/widget/widget_asset.zip', 'application/zip', '09857', '1', '1330434513');";
db_query($sql);
$fid = db_last_insert_id('files', 'fid');
$sql = "INSERT INTO `upload` (`fid`, `nid`, `vid`, `description`, `list`, `weight`) VALUES ('$fid','$newNode->nid', '$newNode->vid', 'widget_asset.zip', '0', '0');";
db_query($sql);

$sql = "INSERT INTO `files` (`fid`, `uid`, `filename`, `filepath`, `filemime`, `filesize`, `status`, `timestamp`) 
  VALUES (NULL, '1', 'widget.png', 'sites/default/files/widget/widget_asset.png', 'image/png', '027461', '1', '1330434513');";
db_query($sql);

$fid = db_last_insert_id('files', 'fid');
$sql = "INSERT INTO `upload` (`fid`, `nid`, `vid`, `description`, `list`, `weight`) VALUES ('$fid','$newNode->nid', '$newNode->vid', 'widget_asset.png', '0', '0');";
db_query($sql);
